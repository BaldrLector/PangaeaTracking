...
**************************************************************************************************/
#include "main_engine/utils/qx_ctbf_ss.h"
qx_ctbf_ss::qx_ctbf_ss()
{
	m_box = NULL;
	m_jk = NULL;
	m_wk = NULL;
...
int qx_ctbf_ss::init(int h_original, int w_original, int spatial_filter, double sigma_spatial, double sigma_range)
{
...
int qx_ctbf_ss::joint_bilateral_filter(unsigned char**image_filtered, unsigned char**image, unsigned char**texture, unsigned char**mask, int nr_scale,
...
int qx_ctbf_ss::joint_bilateral_filter(float**image_filtered, float**image, unsigned char **texture, unsigned char**mask, int nr_scale,
	double sigma_spatial, double sigma_range)
{
	unsigned char image_min, image_max;
	int y, x, jk_0, jk_1;
